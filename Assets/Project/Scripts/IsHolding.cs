...
namespace Assets.Project.ChessEngine
{
    public class IsHolding : MonoBehaviour
    {
        ...
        public GameObject otherRef = null;
        ...
        {
            if (other.gameObject.tag == "Piece" && !inHands && otherRef == null)
            {
                inHands = true;
                ...
                otherRef = other.gameObject;
            }
        }

        private void OnTriggerExit(Collider other)
        {
            if (other.gameObject.tag == "Piece" && inHands && otherRef == other.gameObject)
            {
        ...
        public int XAndZCoordinatesOfObject(float xCoord, float zCoord)
        {
            ...
            int file = 7 - Mathf.FloorToInt(local.z / squareSizeZ);
