...
using UnityEditor;
    ...
    public class BoardManager : MonoBehaviour
    {
        ...
        public PieceHands[,] board { set; get; }
        private PieceHands selectedPiece;
        ...
        void MovePiece(int x, int y)
        {
            ...
            // En Passant
            if (selectedPiece.type == "PawnH" && x == EnPassant[0] && y == EnPassant[1])
            {
        ...
        void MovePieceHelper(PieceHands PieceToMove, int x, int y)
        {
        ...
        void SpawnPiece(int index, int x, int y, int rotation = 0)
        {
            ...
            temp.transform.SetParent(transform);
            board[x, y] = temp.GetComponent<PieceHands>();
